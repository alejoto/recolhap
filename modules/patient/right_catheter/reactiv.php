<div id="reactiv">
    ...
    <div class="row">
        <div class="span5 text-info">Aviso: los campos azules (*) SON OBLIGATORIOS</div>
        <br>
        <br>
    </div>
    ...
    <div id="drugdependant">
        ...
        <div class="row">
            ...
            <div class="span2">
                <div class="input-append">
                    <input type="text" id="post_cardiac_index" placeholder="L/min/Mt2" 
                    class="span2 react" name="post_cardiac_index" disabled>
        ...
        <div class="row">
            ...
            <div class="span1">
                <input type="text" id="post_rt_atr_oxim" placeholder="aur der" 
                class="span1 react" name="post_rt_atr_oxim" maxlength="2">
            </div>
            <div class="span1">
                <input type="text" id="post_rt_ventr_oxim" placeholder="vt der" 
                class="span1 react" name="post_rt_ventr_oxim" maxlength="2">
            </div>
            <div class="span1">
                <input type="text" id="post_pulm_artery" placeholder="at pulm." 
                class="span1 react" name="post_pulm_artery" maxlength="2">
            </div>
        </div>
        <div class="row">
