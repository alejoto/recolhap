<div id="hb_and_others" style="padding-left: 40px;text-align:left">
	<div class="row">
		<div class="well well-small span8">
			<h4>
				HEMOGLOBINA - TIROIDES - D&Iacute;MERO D - TROPONINA - P&Eacute;PTIDO NATRIUR&Eacute;TICO - VIH
			</h4>
		</div>
	</div>
	<div class="row" >
	...
	<div class="row">
		...
		<div class="offset2 span1" style="text-align:right">
			T4 libre
		</div>
	...
	<div class="row">
		<div class="span8">
			<b>P&eacute;ptido natriur&eacute;tico cerebral B-PN (mg/dL)</b>
		</div>
	</div>
