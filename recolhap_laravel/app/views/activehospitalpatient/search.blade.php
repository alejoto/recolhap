	...
	<div class="row-fluid">
		<form action="" class="form-horizontal span5 patient_form" onsubmit="return false">
			...
			<div class="patient_select">
				...
				<a href="{{URL::to('activehospital/patient')}}" class='text-info'>Ver lista de pacientes ( {{Auth::user()->investigator->hospital->hospital_name}})</a>
			</div>
		</form>
			...
			<div id="enterpatient">
				...
				<div  class="pt_enter_form" >
					...
					<div class="btn-group" id="group_save_patient">
						<button type="" class="btn btn-info pnt_ctrl2" id="save_patient">
